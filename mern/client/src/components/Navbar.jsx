    ...
    <div>
      <nav className="flex justify-between items-center mb-6">
        <NavLink to="/">
          ...
          src="https://www.svgrepo.com/show/331488/mongodb.svg"></img>
        </NavLink>

        <NavLink className="inline-flex items-center justify-center whitespace-nowrap text-md 
        ...
        border-input bg-background hover:bg-slate-100 h-9 rounded-md px-3" to="/create">
          Create Employee
        </NavLink>
      </nav>
    </div>
